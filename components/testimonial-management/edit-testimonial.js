...
import { handleGetTestimonialDetails, handleUpdateTestimonial } from '@/utils/services/testimonial-management';
...
const EditTestimonial = () => {
  ...
  useEffect(() => { console.log(selectedFiles, "selectedFiles *") }, [selectedFiles])
                      ...
                      <Form>
                        <div className="add-product">
                          ...
                          <div className="col-md-12">
                            ...
                            {selectedFiles?.length === 0 && testimonialDetails && testimonialDetails?.length > 0 &&
                              <div className="mb-4">
                                <img
                                  src={testimonialDetails && testimonialDetails[0]?.image_url}
                                  style={{
                                    width: "80px",
                                    height: "80px",
                                    objectFit: "cover"
