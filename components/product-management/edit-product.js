...
import { categoryList, vendorApproveList, vendorList } from "@/utils/services/rfq";
import { addProducts, getProducts, handleUpdateProduct } from "@/utils/services/products";
...
const EditProduct = () => {
  ...
  useEffect(() => {
    if (categoryData.length > 0 && categories.length > 0 && parentCategories.length > 0) {
  ...
  }, [categoryData, categories, parentCategories,
    levelOneCatSelected,
    levelTwoCatSelected,
  ...
  const initialValues = {
    ...
    description: productDetailsData.description ? productDetailsData.description : "",
    manufacturer: productDetailsData.manufacturer ? productDetailsData.manufacturer : "",
    availability: productDetailsData.availability !== undefined ? productDetailsData.availability : "",
    categories: productDetailsData.product_categories ? [productDetailsData.product_categories] : [],
    featured: productDetailsData.featured ? productDetailsData.featured : "",
    status: 1,
    approved_id: productDetailsData.vendor_approved_by && productDetailsData.vendor_approved_by?.length > 0 ? productDetailsData.vendor_approved_by?.map((item) => item) : "",
    approved_name: productDetailsData.approved_name ? productDetailsData.approved_name : "",
    variations: variantData.length != 0 ? variantData : [{ attribute: "", attributeValue: "" }],
    vendor: productDetailsData.vendor ? productDetailsData.vendor : "",
    is_featured: (productDetailsData.is_featured === 0 || productDetailsData.is_featured === 1) ? productDetailsData.is_featured : "",
  };
    ...
    getProducts(id)
      .then((response) => {
        ...
        response.data.product_categories?.map((data) => {
          category.push({
            label: data.category_name, value: data.id
          })
        })
        ...
        response.data.product_variants.map((data) => {
          variant.push({
            attribute: data.variant_name, attributeValue: data.variant_value
          })
        })
                                      ...
                                      <div className="form-group">
                                        <Select
                                          ...
                                          onChange={(e) => {
                                            ...
                                            if (e && e.value) {
                                              setParentSelectValue({ label: e.label, value: e.value });
                                        ...
                                        <div className="form-group">
                                          <Select
                                            ...
                                            onChange={(e) => {
                                              ...
                                              if (e && e.value) {
                                                setlevelOneSelectValue({ label: e.label, value: e.value })
                                                setCat_id(e.value);
                                              } else {
                                                setCat_id("");
                                              }
                                        ...
                                        <div className="form-group">
                                          <Select
                                            ...
                                            onChange={(e) => {
                                              ...
                                              if (e && e.value) {
                                                setlevelTwoSelectValue({ label: e.label, value: e.value })
                                                setCat_id(e.value);
                                              } else {
                                                setCat_id("");
                                              }
                                        ...
                                        <div className="form-group">
                                          <Select
                                            ...
                                            onChange={(e) => {
                                              ...
                                              if (e && e.value) {
                                                setlevelThreeSelectValue({ label: e.label, value: e.value })
                                                setCat_id(e.value);
                                              } else {
                                                setCat_id("");
                                              }
                                        ...
                                        <div className="form-group">
                                          <Select
                                            ...
                                            onChange={(e) => {
                                              ...
                                              if (e && e.value) {
                                                setlevelFourSelectValue({ label: e.label, value: e.value })
                                                setCat_id(e.value);
                                              } else {
                                                setCat_id("");
                                              }
                                        ...
                                        <div className="form-group">
                                          <Select
                                            ...
                                            onChange={(e) => {
                                              ...
                                              if (e && e.value) {
                                                setlevelFiveSelectValue({ label: e.label, value: e.value })
                                                setCat_id(e.value);
                                              } else {
                                                setCat_id("");
                                              }
                                        ...
                                        <div className="form-group">
                                          <Select
                                            ...
                                            onChange={(e) => {
                                              ...
                                              if (e && e.value) {
                                                setlevelSixSelectValue({ label: e.label, value: e.value })
                                                setCat_id(e.value);
                                              } else {
                                                setCat_id("");
                                              }
                                ...
                                <div className="col-md-4">
                                  ...
                                  <div className="form-group">
                                    ...
                                    <Select
                                      ...
                                      isClearable={true}
                                      value={vendorApprovedList.filter(option => values?.approved_id?.includes(option?.value))}
                                      styles={customSelectStyles}
                                    ...
                                    />
                                    <ErrorMessage name={'approved_id'} component="div" className="form-error" />
                                  </div>
                                </div>
                                  ...
                                  <div className="row featured-image">
                                    ...
                                    <Field
                                      ...
                                      onChange={(e) => {
                                        ...
                                        setFieldValue("featured", selectFiles);
                                        setImage(URL.createObjectURL(selectFiles));
                                        setSelectedFeaturedFiles([selectFiles])
                                      }}
                                    />
                                    {/* {touched.featured && errors.featured && <div className="form-error">{errors.featured}</div>} */}

                                    {productDetailsData.product_images && !image &&
                                      productDetailsData.product_images.length != 0 &&
                                      productDetailsData.product_images.map((data, index) => {
                                        return (
                                          (data.is_featured == 1 &&
                                  ...
                                  <div className="col-md-12">
                                    <div className="specification ">
                                      ...
                                      <FieldArray name="variations">
                                        {({ push, remove }) => (
                                          <>
                                            {variantData && values.variations.map((field, index) => (
